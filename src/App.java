...
public class App {
    ...
    public static void main(String[] args) {
        ...
        for (int size : sizes) {
            ...
            long bubbleSortTime = measureTime((arr) -> bucketSort(arr, App::bubbleSort), subarray);

            // Bucket Sort com Selection Sort interno
            System.out.print("Bucket Sort (Selection Sort): ");
            long selectionSortTime = measureTime((arr) -> bucketSort(arr, App::selectionSort), subarray);

            // Bucket Sort com Insertion Sort interno
            System.out.print("Bucket Sort (Insertion Sort): ");
            long insertionSortTime = measureTime((arr) -> bucketSort(arr, App::insertionSort), subarray);

            // Bucket Sort com Merge Sort interno
            System.out.print("Bucket Sort (Merge Sort): ");
            long mergeSortTime = measureTime((arr) -> bucketSort(arr, App::mergeSort), subarray);

            // Bucket Sort com Quick Sort interno
            System.out.print("Bucket Sort (Quick Sort): ");
            long quickSortTime = measureTime((arr) -> bucketSort(arr, App::quickSort), subarray);

            // Bucket Sort com Counting Sort interno
            System.out.print("Bucket Sort (Counting Sort): ");
            long countingSortTime = measureTime((arr) -> bucketSort(arr, App::countingSort), subarray);
